...
import { toggleSidebar, toggleMobileSidebar, closeMobileSidebar } from '@store/slices/uiSlice';
  ...
  if (isMobile) {
    return (
      <>
        ...
        <nav className="fixed bottom-0 left-0 right-0 z-30 bg-background-secondary/80 backdrop-blur-lg border-t border-glass-border lg:hidden">
